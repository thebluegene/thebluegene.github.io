  ...
  <div className="social-media">
    <ul className="social-media__list">
      <li className="social-media__list-item">
        <a target="_blank" href="https://www.flickr.com/people/thebluegene/">
          <i className="fa fa-lg fa-flickr" aria-hidden="true"></i>
        </a>
      </li>
      <li className="social-media__list-item">
        <a target="_blank" href="https://vimeo.com/thebluegene">
          <i className="fa fa-lg fa-vimeo" aria-hidden="true"></i>
        </a>
      </li>
      <li className="social-media__list-item">
        <a target="_blank" href="https://www.linkedin.com/in/geneang/">
          <i className="fa fa-lg fa-linkedin-square" aria-hidden="true"></i>
        </a>
      </li>
      <li className="social-media__list-item">
        <a target="_blank" href="https://www.github.com/thebluegene/">
